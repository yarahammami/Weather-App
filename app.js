...
const APIKEY = '9141e0dc47f737b2d7cd81b2002c149b';
...
currentWeatherItemsEl.innerHTML = 
    `<div class="weather-item">
                ...
                if(idx == 0){
                   currentTempEl.innerHTML = `<img src="http://openweathermap.org/img/wn/${day.weather[0].icon}@4x.png" alt="" class="w-icon">
                   <div class="other">
